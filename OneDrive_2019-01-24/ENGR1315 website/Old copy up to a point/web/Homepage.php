			...
			<div class="header-nav">
				<nav class="navbar navbar-default">
					...
					<div class="navbar-header">
					    ...
					    <h1><a class="navbar-brand" href="index.html"><i class="glyphicon glyphicon-education" aria-hidden="true"></i>
							<span>Texas Tech University </a></h1>
					</div>
					<!-- Collect the nav links, forms, and other content for toggling -->
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							<li><a class="hvr-overline-from-center button2" href="services.html">About Course</a></li>
							<li><a class="hvr-overline-from-center button2" href="contact.html">Contact Us</a></li>
						</ul>
...
<div class="banner-bottom">
	<div class="container">
		<h2 class="tittle">WELCOME TO TEXAS TECH UNIVERSITY</h2> 
		<div class="bottom-grids">
		  				<div class="col-md-3 ser-first-grid text-center">
						<a href="Youtube Page.html"><img src="images/1.jpg" alt="" width="182" height="165"/>
						<h3>Youtube Videos</h3>
						<p>Lecture material can be found here</p>
						</a>
						<p>&nbsp;</p>
		  </div>
							<div class="col-md-3 ser-first-grid text-center">
						<img src="images/navigate.jpg" alt=""/>
						<h3>Where's my room?</h3>
						<p>Video instructions to navigate to various engineering buildings</p>
		  </div>
						<div class="col-md-3 ser-first-grid text-center">
						<img src="images/facility.jpg" alt="" width="238" height="165"/>
						<h3>Where's the lab?</h3>
						<p>Overview of major labs</p>
		  </div>
							<div class="col-md-3 ser-first-grid text-center">
						<img src="images/blackboard.jpg" alt="" height="163"/>
						<h3>Blackboard</h3>
						<p>Re-directs to Blackboard Website</p>
		  </div>			
